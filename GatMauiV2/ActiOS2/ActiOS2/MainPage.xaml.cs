...
namespace ActiOS2
{
    public partial class MainPage : ContentPage
    {
        ...
        //se definen las variabes de turno de los botones y puntaje de los jugadores
        byte Turno = 0;
        byte bot1 = 0;
        byte bot2 = 0;
        byte bot3 = 0;
        ...
        public void x1y1_Click(object sender, EventArgs args)
        {
            ...
            if (Turno == 0)
            {
                ...
                //cambia elo valor de las variables 
                Turno = 1;
                bot1 = 1;
            ...
            else
            {
                ...
                //se cambia la imagen del turno pór la del jugador 1
        ...
        //funcion para verificar quien gano
        public void Win()
        {
            // si los botones 1,2,3 son del jugador 1 
            if (bot1 == 1 && bot2 == 1 && bot3 == 1)
            {
                //se cambia las imagenes 
                //se llama a la funcion block
                ...
                jugadorenjuego.Source = "tacha.png";
                Block();
                //se suma 1 al puntuaje del jugador
                //manda un mensaje de quin gano
                //se imprime el puny}tuaje
                puntaje1 = puntaje1 + 1;
            ...
            // si los botones 1,2,3 son del jugador  2
            ...
            // si los botones 4,5,6 son del jugador  1
            ...
            // si los botones 4,5,6 son del jugador 2
            ...
            // si los botones 7,8,9 son del jugador 1
            ...
            // si los botones 7,8,9 son del jugador 2
            ...
            // si los botones 1,4,7 son del jugador 1
            ...
            // si los botones 1,4,7 son del jugador 2
            ...
            // si los botones 2,5,8 son del jugador 1
            ...
            // si los botones 2,5,8 son del jugador 2
            ...
            // si los botones 3,6,9 son del jugador 1
            ...
            // si los botones 3,6,9 son del jugador 2
            ...
            // si los botones 1,5,9 son del jugador 1
            ...
            // si los botones 1,5,9 son del jugador 2
            ...
            // si los botones 3,5,7 son del jugador 1
            ...
            // si los botones 3,5,7 son del jugador 2
            ...
            //si el valor de los botones es diferente a 0 se ejecuta
        ...
        public void Block()
        {
            //se desabilitan los botones donde pueden jugar los jugadores
            x1y1.IsEnabled = false;
            x1y2.IsEnabled = false;
            x1y3.IsEnabled = false;
            x2y1.IsEnabled = false;
        ...
        //funcion de para resetear todo a su valor inicial
        private void Reset_Click(object sender, EventArgs e)
        {
            //se habilitan los bototes donde pueden jugar los jugadores
            x1y1.IsEnabled = true;
            x1y2.IsEnabled = true;
            x1y3.IsEnabled = true;
            x2y1.IsEnabled = true;
            ...
            x3y2.IsEnabled = true;
            x3y3.IsEnabled = true;
            //se ponen las imagenes a los botones
            ...
            //se regresa a su valor inicial las variables/botones
            bot1 = 0;
            bot2 = 0;
            bot3 = 0;
            bot4 = 0;
