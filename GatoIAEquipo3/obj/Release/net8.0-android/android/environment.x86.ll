...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1567880234, ; hash 0x5d73f42a, from name: libaot-GatoIA.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1759330050, ; hash 0x68dd3f02, from name: libaot-GatoIA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 180
	...
	%struct.DSOCacheEntry {
		i64 2015769839, ; hash 0x782634ef, from name: aot-GatoIA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 214
	...
	%struct.DSOCacheEntry {
		i64 2179366055, ; hash 0x81e67ca7, from name: GatoIA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 237
	...
	%struct.DSOCacheEntry {
		i64 3026765827, ; hash 0xb468c803, from name: aot-GatoIA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 343
	...
	%struct.DSOCacheEntry {
		i64 3349602916, ; hash 0xc7a6e264, from name: GatoIA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 379
