...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2308426938792435810, ; hash 0x20092e11fcaa6062, from name: aot-GatoIA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 55
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4999491769483850146, ; hash 0x4561c346a192f1a2, from name: libaot-GatoIA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 121
	...
	%struct.DSOCacheEntry {
		i64 6238401214647565652, ; hash 0x569340da2d6efd54, from name: GatoIA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 138
	...
	%struct.DSOCacheEntry {
		i64 7968457204208159267, ; hash 0x6e95a59bc8baca23, from name: libaot-GatoIA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 191
	...
	%struct.DSOCacheEntry {
		i64 12256790978232766754, ; hash 0xaa18de7497c6d122, from name: aot-GatoIA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 309
	...
	%struct.DSOCacheEntry {
		i64 18279848078483497549, ; hash 0xfdaf10fa021da24d, from name: GatoIA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GatoIA.dll.so
		ptr null; void* handle (0x0)
	}, ; 467
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0a129551-d504-4c58-b475-28232eef6057\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.gatoia\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [21 x i8] c"libaot-GatoIA.dll.so\00", align 16
